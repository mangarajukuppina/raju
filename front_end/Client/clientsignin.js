...
form.addEventListener("submit" ,async (e) => {
    ...
    const response =await fetch(`http://localhost:8080/clientlogin?email=${email.value}&password=${pwd.value}`);
    ...
    //   window.open(URL="./index.html","_self");
      window.open(URL="http://127.0.0.1:5500/front_end/front_end/Client/client_page.html","_self");
    }
    o(); 
  }
